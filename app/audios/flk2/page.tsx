...
export default function AudiosFlk2Page() {
      ...
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#121f1d]/60 sm:text-base">
            Open FLK 2 subjects with audio-only learning.
          </p>
        </div>
      </header>
      <Link href="/audios" className="mb-4 inline-flex text-sm font-medium text-[#0d4a42] hover:text-[#26d9c0]">
        ← Back to audios
      </Link>
      <section className="mb-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <label className="text-sm font-medium text-slate-700" htmlFor="audios-flk2-subject-search">
          Search FLK 2 subjects
        </label>
        <input
          id="audios-flk2-subject-search"
          value={query}
