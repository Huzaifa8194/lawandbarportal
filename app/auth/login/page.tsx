      ...
      <div className="relative z-10 w-full max-w-[440px]">
        ...
        <main className="rounded-2xl border border-white/10 bg-white p-6 shadow-2xl shadow-black/25 sm:p-8">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#121f1d]/65">
            Sign in with Google or the same student email and password as the main Law &amp; Bar website. We
            match your account to SQE bundle orders, or you can activate with an administrator-generated access
            code when prompted.
          </p>
