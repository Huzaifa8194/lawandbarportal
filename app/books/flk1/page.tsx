...
export default function BooksFlk1Page() {
      ...
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm leading-relaxed text-[#121f1d]/60 sm:text-base">
            Open FLK 1 subjects and study books with integrated audio.
          </p>
        </div>
      </header>
      <section className="mb-5 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <label className="text-sm font-medium text-slate-700" htmlFor="books-flk1-subject-search">
          Search FLK 1 subjects
        </label>
        <input
          id="books-flk1-subject-search"
          value={query}
