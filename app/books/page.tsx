...
export default function BooksPage() {
  ...
  return (
    <PortalShell
      title="Books"
      subtitle="Choose FLK 1 or FLK 2, open subjects, and study with integrated books and audio support."
    >
      <section className="grid gap-4 md:grid-cols-2">
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">Open FLK 1 subjects with book-focused study workspace.</p>
          <Link
            href="/books/flk1"
        ...
        <article className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">Open FLK 2 subjects with book-focused study workspace.</p>
          <Link
            href="/books/flk2"
            className="mt-4 inline-block rounded-lg bg-slate-900 px-3 py-1.5 text-sm font-medium text-white"
          >
      ...
      <section className="space-y-4">
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <label className="text-sm font-medium text-slate-700" htmlFor="books-search">
            Search subjects
          </label>
          <input
            id="books-search"
        ...
        <SubjectsList track="FLK 1" query={query} basePath="/books" />
      </section>

      <section className="space-y-4">
        <h3 className="text-lg font-semibold">FLK 2 Subjects</h3>
        <SubjectsList track="FLK 2" query={query} basePath="/books" />
      </section>
    </PortalShell>
  );
}
